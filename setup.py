...
def getDataSource(data_path):
    ...
    with open(data_path) as csv_file:
        ...
        for row in csv_reader:
            ...
            cold_drink_sales.append(float(row["Ice-cream Sales(rupees)"]))
...
def setup():
    data_path = r"E:\rv\whitehatjr\python\colleration\data\Ice-Cream_vs_Cold-Drink_vs_Temperature_Ice_Cream_Sale_vs_Temperature_data.csv"
